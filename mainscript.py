...
def redraw_game_window():
    if game_start:
        ...
        seed1_amount_text = font2.render(str(seed1_amount), 1, (0, 0, 0))
        seed2_amount_text = font2.render(str(seed2_amount), 1, (0, 0, 0))
        seed3_amount_text = font2.render(str(seed3_amount), 1, (0, 0, 0))
        ...
        wood_val = font2.render('Wood: ' + str(wood), 1, (0, 0, 0))
        win.blit(wood_val, (730, 15))
    else:
        if shop_open:
            win.fill((222,184,135))
            shop_close_but.draw(win, (0, 0, 0))
            wood_val = font2.render('Wood: ' + str(wood), 1, (0, 0, 0))
            win.blit(wood_val, (10, 15))
            money_val = font2.render('Money: ' + str(money), 1, (0, 0, 0))
            win.blit(money_val, (175, 15))
            exchange1.draw(win, (0, 0, 0))
            exchange2.draw(win, (0, 0, 0))
            exchange3.draw(win, (0, 0, 0))
...
buy_seed1_1 = Button(25, 150, 290, 75, (255, 255, 255), 0, 'Buy 1 Brown Seed ($4)', True)
buy_seed1_2 = Button(350, 150, 290, 75, (255, 255, 255), 0, 'Buy 5 Brown Seeds ($20)', True)
buy_seed1_3 = Button(675, 150, 290, 75, (255, 255, 255), 0, 'Buy 20 Brown Seeds ($80)', True)
buy_seed2_1 = Button(25, 250, 290, 75, (255, 255, 255), 0, 'Buy 1 Creme Seed ($60)', True)
buy_seed2_2 = Button(350, 250, 290, 75, (255, 255, 255), 0, 'Buy 5 Creme Seeds ($300)', True)
buy_seed2_3 = Button(675, 250, 290, 75, (255, 255, 255), 0, 'Buy 20 Creme Seeds ($1200)', True)
buy_seed3_1 = Button(25, 350, 290, 75, (255, 255, 255), 0, 'Buy 1 Dark Seed ($1000)', True)
buy_seed3_2 = Button(350, 350, 290, 75, (255, 255, 255), 0, 'Buy 5 Dark Seeds ($5000)', True)
buy_seed3_3 = Button(675, 350, 290, 75, (255, 255, 255), 0, 'Buy 20 Dark Seeds ($20000)', True)
exchange1 = Button(buy_seed1_1.x + buy_seed1_1.width // 2 - 100, 75, 200, 50, (0, 0, 0), 0, 'Exchange 5 Wood', True)
exchange2 = Button(buy_seed1_2.x + buy_seed1_2.width // 2 - 100, 75, 200, 50, (0, 0, 0), 0, 'Exchange 50 Wood', True)
exchange3 = Button(buy_seed1_3.x + buy_seed1_3.width // 2 - 100, 75, 200, 50, (0, 0, 0), 0, 'Exchange 500 Wood', True)
seeds = []
sprouts = []
saplings = []
trees = []
...
while run:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if shop_open:
                if shop_close_but.is_over(pos):
                    ...
                    game_start = True
                    shop_open = False
                if exchange1.is_over(pos):
                    if wood >= 5:
                        wood -= 5
                        money += 1
                if exchange2.is_over(pos):
                    if wood >= 50:
                        wood -= 50
                        money += 10
                if exchange3.is_over(pos):
                    if wood >= 500:
                        wood -= 500
                        money += 100
                                ...
                                for sapling in saplings:
                                    ...
                                    if sapling.touching:
                                        if sapling.type == 1:
                                            wood += sapling.size * 3
                                        if sapling.type == 2:
                                            wood += sapling.size * 60
                                        if sapling.type == 3:
                                            wood += sapling.type * 1200
                                        saplings.pop(saplings.index(sapling))
        ...
        if event.type == pygame.MOUSEMOTION:
            ...
            exchange1.highlight_check(pos)
            exchange2.highlight_check(pos)
            exchange3.highlight_check(pos)
